...
def print_credits():
	...
	table.add_row("GUNA ", "gunabarathi1505@gmail.com ")
	console.print(table)
...
if __name__ == "__main__":
	...
	cprint(figlet_format('IHIDE!', font='starwars'),'yellow', attrs=['bold'])
	print_credits()
	print()
	print("[bold]IHIDE[/bold] allows you to hide texts inside an image. You can also protect these texts with a password using AES-256.")
	print()
